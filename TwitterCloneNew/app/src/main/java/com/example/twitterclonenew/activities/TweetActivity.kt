...
import kotlinx.android.synthetic.main.activity_tweet_activity.*
...
class TweetActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_tweet_activity)
    ...
    fun postTweet(v: View) {
        ...
        tweetId.set(tweet)
            ...
            .addOnFailureListener { exception ->
                ...
                tweetProgressLayout.visibility = View.GONE
                Toast.makeText(this, "Faild to post the tweet.", Toast.LENGTH_SHORT).show()
            }
    }
